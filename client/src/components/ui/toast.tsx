...
const toastVariants = cva(
  cn(
    ...
    "rounded-md border p-4 pr-6",
    "group pointer-events-auto relative overflow-hidden shadow-lg transition-all data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-[var(--radix-toast-swipe-end-x)] data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=move]:transition-none",
  ...
  ),
  {
    variants: {
      variant: {
        default: "border bg-white text-black border-green-500",
        destructive:
          "destructive group border-destructive bg-white text-destructive",
      },
    },
    defaultVariants: {
      variant: "default",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ...
    className={cn(
      ...
      "shrink-0 rounded-md border bg-transparent text-sm font-medium transition-colors",
      "hover:bg-secondary",
