      ...
      <DialogContent className="overflow-hidden p-0">
        <Command
          className={cn(
            ...
            '[&_[cmdk-group]]:px-2 [&_[cmdk-input-wrapper]_svg]:h-5 [&_[cmdk-input-wrapper]_svg]:w-5 [&_[cmdk-input]]:h-12',
...
>(({ className, ...props }, ref) => (
  <div className="flex items-center border-b px-3" cmdk-input-wrapper="">
    ...
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        'h-10 w-full py-3 text-sm ',
        'flex rounded-md bg-transparent outline-none placeholder:text-muted-foreground',
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex px-2 py-1.5 text-sm text-black hover:bg-black hover:text-white',
      'cursor-default select-none items-center rounded-sm outline-none',
